...
|---:|:-----------------|:-------------------------------------------------------------------------------------------------------------------------------|:--------------|:--------------|:------------|
|  0 | property_type    | 부동산 유형\n (아파트, 오피스텔, 단독다가구, 연립다세대, 토지, 분양입주권, 공장창고등)                                          | String        | 아파트        | 필수        |
|  1 | trade_type       | 거래 유형\n (매매, 전월세)                                                                                                      | String        | 매매          | 필수        |
|  2 | sigungu_code     | 시군구의 5자리 지역코드\n (서울 서초구: 11650, 경기 성남 분당구: 41135)                                                         | String        | 11650         | 필수        |
|  3 | year_month       | 조회 년월 (단일 월 조회 시 필수)\n (2023년 1월: 202301)\n ※ start_year_month와 end_year_month 모두 입력 시 기간 내 조회가 실행됨 | String        | 202301        | 조건부 필수 |
|  4 | start_year_month | 조회 시작 년월 (기간 내 조회 시 필수)\n (2022년 1월 202201)                                                                     | String        | 202201        | 조건부 필수 |
|  5 | end_year_month   | 조회 종료 년월 (기간 내 조회 시 필수)\n (2022년 12월: 202212)                                                                   | String        | 202212        | 조건부 필수 |
|  6 | verbose          | 데이터 조회 진행 상황 메시지 출력 여부\n (출력: True, 미출력: False)\n ※ 기본값: False   
