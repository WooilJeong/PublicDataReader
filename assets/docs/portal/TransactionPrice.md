...
| 일                   | 일                   | 17                   |
| 거래금액             | 거래금액(만원)       | 180000               |
| 도로명건물본번호코드 | 도로명건물본번호코드 | 00020                |
| 도로명건물부번호코드 | 도로명건물부번호코드 | 00000                |
| 도로명시군구코드     | 도로명시군구코드     | 11650                |
| 도로명일련번호코드   | 도로명일련번호코드   | 01                   |
| 도로명지상지하코드   | 도로명지상지하코드   | 0                    |
| 도로명코드           | 도로명코드           | 4163659              |
| 법정동본번코드       | 법정동본번코드       | 1338                 |
| 법정동부번코드       | 법정동부번코드       | 0000                 |
| 법정동시군구코드     | 법정동시군구코드     | 11650                |
| 법정동읍면동코드     | 법정동읍면동코드     | 10800                |
| 법정동지번코드       | 법정동지번코드       | 1                    |
| 일련번호             | 일련번호             | 11650-532            |
| 거래유형             | 해제사유발생일       | 중개거래             |
| 중개사소재지         | 중개 및 직거래 여부  | 서울 서초구          |
| 해제사유발생일       | 시군구 단위          | 23.01.17             |
| 해제여부             | 해제여부             | O                    |
