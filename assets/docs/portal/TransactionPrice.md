...
| 항목명(국문)         | 항목구분   | 샘플데이터                | 항목설명             |
|:---------------------|:-----------|:--------------------------|:---------------------|
| 거래금액             | 필수       | 82500                     | 거래금액             |
| 건축년도             | 필수       | 2008                      | 건축년도             |
| 년                   | 필수       | 2015                      | 년                   |
| 도로명               | 필수       | 사직로8길                 | 도로명               |
| 도로명건물본번호코드 | 필수       | 4                         | 도로명건물본번호코드 |
| 도로명건물부번호코드 | 필수       | 0                         | 도로명건물부번호코드 |
| 도로명시군구코드     | 필수       | 11110                     | 도로명시군구코드     |
| 도로명일련번호코드   | 필수       | 3                         | 도로명일련번호코드   |
| 도로명지상지하코드   | 필수       | 0                         | 도로명지상지하코드   |
| 도로명코드           | 필수       | 4100135                   | 도로명코드           |
| 법정동               | 필수       | 사직동                    | 법정동               |
| 법정동본번코드       | 필수       | 9                         | 법정동본번코드       |
| 법정동부번코드       | 필수       | 0                         | 법정동부번코드       |
| 법정동시군구코드     | 필수       | 11110                     | 법정동시군구코드     |
| 법정동읍면동코드     | 필수       | 11500                     | 법정동읍면동코드     |
| 법정동지번코드       | 필수       | 1                         | 법정동지번코드       |
| 아파트               | 필수       | 광화문풍림스페이스본(9-0) | 아파트               |
| 월                   | 필수       | 12                        | 월                   |
| 일                   | 필수       | 1~10                      | 일                   |
| 일련번호             | 필수       | 11110-2203                | 일련번호             |
| 전용면적             | 필수       | 94.51                     | 전용면적             |
| 지번                 | 필수       | 9                         | 지번                 |
| 지역코드             | 필수       | 11110                     | 지역코드             |
| 층                   | 필수       | 11                        | 층                   |
...
| 항목명(국문)   | 항목구분   | 샘플데이터   | 항목설명       |
|:---------------|:-----------|:-------------|:---------------|
| 갱신요구권사용 | 옵션       | 사용         | 갱신요구권사용 |
| 건축년도       | 필수       | 1993         | 건축년도       |
| 계약구분       | 옵션       | 갱신         | 계약구분       |
| 계약기간       | 옵션       | 22.02~24.03  | 계약기간       |
| 계약면적       | 필수       | 61.61        | 계약면적       |
| 년             | 필수       | 2022         | 년             |
| 법정동         | 필수       | 청운동       | 법정동         |
| 보증금액       | 필수       | 34000        | 보증금액       |
...
| 구분           | 필수       | 입              | 분양권/입주권 구분 |
| 년             | 필수       | 2015            | 계약년도           |
| 단지           | 필수       | 종로 포레스트힐 | 분양권 단지명      |
| 법정동         | 필수       | 교남동          | 물건 소재 법정동   |
| 시군구         | 필수       | 종로구          | 물건 소재 시군구   |
| 월             | 필수       | 12              | 계약월             |
| 일             | 필수       | 11~20           | 계약일             |
| 전용면적       | 필수       | 35.85           | 전용면적           |
| 지번           | 필수       | 62              | 물건 소재 지번     |
...
| 층             | 필수       | 2            | 층                  |
| 해제여부       | 옵션       | O            | 해제여부            |
| 해제사유발생일 | 옵션       | 21.01.27     | 해제사유발생일      |
| 거래유형       | 필수       | 중개거래     | 중개 및 직거래 여부 |
| 중개업소주소   | 필수       | 서울 서초구  | 시군구 단위         |
...
| 항목명(국문)   | 항목구분   | 샘플데이터   | 항목설명            |
|:---------------|:-----------|:-------------|:--------------------|
| 거래금액       | 필수       | 82500        | 거래금액(만원)      |
| 건축년도       | 필수       | 2015         | 건축년도            |
| 년             | 필수       | 2015         | 계약년도            |
| 대지권면적     | 필수       | 57.43        | 대지권면적          |
| 법정동         | 필수       | 사직동       | 법정동              |
| 연립다세대     | 필수       | 청운빌라B동  | 연립다세대명        |
| 월             | 필수       | 12           | 계약월              |
| 일             | 필수       | 1            | 일                  |
| 전용면적       | 필수       | 94.51        | 전용면적(㎡)        |
| 지번           | 필수       | 9            | 지번                |
...
| 건축년도       | 필수       | 2010                | 건축년도       |
| 계약구분       | 옵션       | 갱신                | 계약구분       |
| 계약기간       | 옵션       | 22.01~24.01         | 계약기간       |
| 년             | 필수       | 2022                | 계약년도       |
| 법정동         | 필수       | 청운동              | 법정동         |
| 보증금액       | 필수       | 42000               | 보증금(만원)   |
| 연립다세대     | 필수       | 효산빌리지          | 연립다세대명   |
| 월             | 필수       | 1                   | 계약월         |
| 월세금액       | 필수       | 0                   | 월세(만원)     |
| 일             | 필수       | 8                   | 일             |
| 전용면적       | 필수       | 65.59               | 전용면적(㎡)   |
| 종전계약보증금 | 옵션       | 40000               | 종전계약보증금 |
| 종전계약월세   | 옵션       | 0                   | 종전계약월세   |
| 지번           | 필수       | 1952-05-01 00:00:00 | 지번           |
| 지역코드       | 필수       | 11110               | 지역코드       |
| 층             | 필수       | 2                   | 층             |
...
| 월             | 필         | 12           | 계약월                |
| 일             | 필         | 21           | 일                    |
| 주택유형       | 필         | 단독         | 주택유형(단독/다가구) |
| 지역코드       | 필         | 11110        | 지역코드              |
| 해제여부       | 필         | O            | 해제여부              |
| 해제사유발생일 | 필         | 21.01.27     | 해제사유발생일        |
...
| 항목명(국문)   | 항목구분   | 샘플데이터        | 항목설명                |
|:---------------|:-----------|:------------------|:------------------------|
| 거래금액       | 필수       | 7000              | 거래금액(만원)          |
| 거래면적       | 필수       | 14                | 거래면적(㎡)            |
| 지분거래구분   | 필수       | 지분              | 지분거래구분(지분/공란) |
| 년             | 필수       | 2015              | 계약년도                |
| 법정동         | 필수       | 필운동            | 법정동                  |
| 지번           | 필수       | 1**               | 지번                    |
| 시군구         | 필수       | 종로구            | 시군구                  |
| 용도지역       | 필수       | 제2종일반주거지역 | 용도지역                |
| 월             | 필수       | 12                | 계약월                  |
| 일             | 필수       | 11                | 일                      |
| 지목           | 필수       | 대                | 지목                    |
| 지역코드       | 필수       | 11110             | 지역코드                |
...
|:---------------|:-----------|:-------------|:------------------------|
| 거래금액       | 필수       | 10800        | 거래금액                |
| 건물면적       | 필수       | 32.25        | 건물 전용/연면적        |
| 건물주용도     | 필수       | 업무         | 건물주용도              |
| 건축년도       | 필수       | 2015         | 건축년도                |
| 구분           | 옵션       | 지분         | 지분거래 구분           |
| 년             | 필수       | 2015         | 계약년도                |
| 대지면적       | 필수       | 50           | 대지권면적              |
| 법정동         | 필수       | 숭인동       | 물건 소재 법정동        |
| 시군구         | 필수       | 종로구       | 물건 소재 시군구        |
| 용도지역       | 필수       | 일반상업     | 물건 소재 토지 용도지역 |
| 월             | 필수       | 12           | 계약월                  |
| 유형           | 필수       | 집합         | 일반/집합 건물 구분     |
| 일             | 필수       | 11~20        | 계약일                  |
| 지역코드       | 필수       | 11110        | 지역코드                |
| 층             | 옵션       | 3            | 거래물건 층(집합건물)   |
...
| 항목명(국문)   | 항목구분   | 샘플데이터   | 항목설명              |
|:---------------|:-----------|:-------------|:----------------------|
| 거래금액       | 필수       | 10800        | 거래금액(만원)        |
| 건물면적       | 필수       | 35.25        | 건물면적(m²)          |
| 건물주용도     | 필수       | 공장         | 건물주용도            |
| 건축년도       | 필수       | 2022         | 건축년도              |
| 구분           | 필수       | 지분         | 지분거래 여부         |
| 년             | 필수       | 2022         | 계약년도              |
...
| 층             | 필수       | 3            | 층                    |
| 해제여부       | 필수       | O            | 해제여부              |
| 해제사유발생일 | 필수       | 20220601     | 해제사유발생일        |
| 거래유형       | 필수       | 중개거래     | 중개 및 직거래 여부   |
| 중개사소재지   | 필수       | 서울 서초구  | 중개업소 주소(시군구) |
